"""Codex SDK provider — OpenAI models with full tool support.
...
class CodexSDKProvider:
    """Provider using the OpenAI Codex SDK (openai-codex-sdk package)."""
    ...
    async def send(
        ...
        *,
        ...
        try:
            ...
            return AgentResponse(text="[Provider timeout — Codex SDK did not respond in time.]")
